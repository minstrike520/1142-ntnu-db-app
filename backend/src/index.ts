...
import { RoomTaskRepository } from "./repositories/roomTaskRepository";
...
import { makeRoomTaskController } from "./controllers/roomTaskController";
...
app.use("/api/v1/rooms", makeRoomTaskRoutes(makeRoomTaskController(roomTaskService)));
