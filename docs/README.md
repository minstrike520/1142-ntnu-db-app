...
Each document is maintained in English and Traditional Chinese. The two versions
are kept in sync; if they disagree, the English version is authoritative.
...
- [CLAUDE.md](CLAUDE.md) — orientation for AI coding agents working in this
  directory (symlinked as `AGENTS.md`)
